...
var API = {
    fetch: function fetch(path) {
        return new Promise(function (resolve, reject) {
            ...
            request.open('GET', uri, true); //true = async
...
function articleTemplate(title, lastReply) {
    var _sanitize = sanitize(title, lastReply),
        _sanitize2 = _slicedToArray(_sanitize, 2),
        safeTitle = _sanitize2[0],
        safeLastReply = _sanitize2[1];

    return '\n        <article class=\'post\'>\n            <h2 class=\'post-title\'>\n                ' + safeTitle + '\n            </h2>\n            <p class=\'post-meta\'>\n                ' + safeLastReply + '\n            </p>\n        </article>';
}

function userTemplate(name, avatar) {
    var _sanitize3 = sanitize(name, avatar),
        _sanitize4 = _slicedToArray(_sanitize3, 2),
        safeName = _sanitize4[0],
        safeAvatar = _sanitize4[1];
...
function sanitize() {
    ...
    try {
        for (var _iterator = variables[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
            ...
            result.push(_xssFilters2.default.inHTMLData(variable));
        }
    } catch (err) {
...
},{"xss-filters":7}],6:[function(require,module,exports){
'use strict';
